...
const config = {
    org: 'telmi-store-cn',
    gistId: 'eb352efaf78c1f1cbd5e7739f5d5e3f3',
    gistFilename: 'telmi-interactive-cn.json',
    ...
    history: true,
    banner: {
        image: 'https://raw.githubusercontent.com/telmi-store-cn/.github/main/profile/banner-telmi.jpg',
        background: '#2e144b',
